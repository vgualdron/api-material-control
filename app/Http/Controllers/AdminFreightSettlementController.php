...
use App\Services\Implementations\AdminFreightSettlementServiceImplement;
use App\Models\Settlement;

class AdminFreightSettlementController extends Controller
{
    ...
    public function __construct(AdminFreightSettlementServiceImplement $service, Request $request){      
